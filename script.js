...
// if (hour < thisHour) {
//     $('textarea').css('background-color', past); 
//     } else if (hour == thisHour) {
//     $('textarea').css('background-color', present);
//     } else {
//     $('textarea').css('background-color', future);
//     }
//     })

if (hour < thisHour) {
$('textarea').addClass('past').removeClass('present').removeClass('future'); 
 } else if (hour === thisHour) {
// $('textarea').addClass('present').removeClass('past').removeClass('future');
// } else {
// $('textarea').addClass('future').removeClass('past').removeClass('present');
// }
}})
